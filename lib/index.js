...
function TouchState(target) {
  ...
  target.addEventListener('touchend', function (e) {
    e.targetTouches.length === 0 && endTouch();
  }, options);
...
function parseKey(key) {
  ...
  return {
    ...
    setWith: getSetWith(eventsAndOptions.indexOf('setWithMouse') !== -1, eventsAndOptions.indexOf('setWithTouch') !== -1, eventsAndOptions.indexOf('setWithHybrid') !== -1)
  };
}
